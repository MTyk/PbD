...
namespace RTT
{
    ...
    {
        template<>
        struct AnyConversion< KUKAInterfaceData >
        {
            typedef orogen::Corba::KUKAInterfaceData CorbaType;
            typedef KUKAInterfaceData   BaseType;
...
namespace orogen_typekits {
    RTT::corba::CorbaTypeTransporter*  KUKAInterfaceData_CorbaTransport()
    {
        return new RTT::corba::CorbaTemplateProtocol< KUKAInterfaceData >();
    }
}
