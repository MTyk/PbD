...
bool orogen_typekits::toCORBA( orogen::Corba::KUKAInterfaceData& corba, KUKAInterfaceData const& value )
{
    if (!toCORBA(corba.samples, value.samples)) return false;

    return true;
}
bool orogen_typekits::fromCORBA( KUKAInterfaceData& value, orogen::Corba::KUKAInterfaceData const& corba )
{
