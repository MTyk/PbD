...
#ifndef __OROGEN_GENERATED_KUKAINTERFACE_MQUEUE_REGISTRATION_HPP
#define __OROGEN_GENERATED_KUKAINTERFACE_MQUEUE_REGISTRATION_HPP
...
namespace orogen_typekits {
    ...
    RTT::types::TypeMarshaller*  KUKAInterfaceData_MQueueTransport(Typelib::Registry const& registry);
