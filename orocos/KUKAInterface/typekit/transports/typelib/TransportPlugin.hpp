...
#ifndef __OROGEN_GENERATED_KUKAINTERFACE_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_KUKAINTERFACE_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class KUKAInterfaceTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        KUKAInterfaceTypelibTransportPlugin();
    ...
    extern KUKAInterfaceTypelibTransportPlugin KUKAInterfaceTypelibTransport;
}
