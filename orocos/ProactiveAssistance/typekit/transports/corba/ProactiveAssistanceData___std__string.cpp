...
namespace RTT
{
    ...
    {
        template<>
        struct AnyConversion< ProactiveAssistanceData >
        {
            typedef orogen::Corba::ProactiveAssistanceData CorbaType;
            typedef ProactiveAssistanceData   BaseType;
...
namespace orogen_typekits {
    RTT::corba::CorbaTypeTransporter*  ProactiveAssistanceData_CorbaTransport()
    {
        return new RTT::corba::CorbaTemplateProtocol< ProactiveAssistanceData >();
    }
}
