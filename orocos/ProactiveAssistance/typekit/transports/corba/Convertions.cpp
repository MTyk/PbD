...
bool orogen_typekits::toCORBA( orogen::Corba::ProactiveAssistanceData& corba, ProactiveAssistanceData const& value )
{
    if (!toCORBA(corba.samples, value.samples)) return false;

    return true;
}
bool orogen_typekits::fromCORBA( ProactiveAssistanceData& value, orogen::Corba::ProactiveAssistanceData const& corba )
{
