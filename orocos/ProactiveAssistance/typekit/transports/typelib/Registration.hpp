...
#ifndef __OROGEN_GENERATED_PROACTIVEASSISTANCE_TYPELIB_REGISTRATION_HPP
#define __OROGEN_GENERATED_PROACTIVEASSISTANCE_TYPELIB_REGISTRATION_HPP
...
namespace orogen_typekits {
    ...
    /** Creates and returns a TypeInfo object for ProactiveAssistanceData */
    orogen_transports::TypelibMarshallerBase* ProactiveAssistanceData_TypelibMarshaller(Typelib::Registry const& registry);
