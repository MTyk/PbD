...
#ifndef __OROGEN_GENERATED_PROACTIVEASSISTANCE_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_PROACTIVEASSISTANCE_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class ProactiveAssistanceTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        ProactiveAssistanceTypelibTransportPlugin();
    ...
    extern ProactiveAssistanceTypelibTransportPlugin ProactiveAssistanceTypelibTransport;
}
